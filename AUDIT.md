...
**AI artifact retention is unaddressed.** Redis TTLs, the PHI audit log, and Langfuse traces are defined in ARCHITECTURE.md as latency and observability parameters. None have a retention window, destruction procedure, or legal hold mechanism. This must be resolved before production deployment.
